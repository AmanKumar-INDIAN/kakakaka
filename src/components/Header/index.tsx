...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full  drop-shadow-1 bg-black border-b-[1px] border-green-700 dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-99999 block rounded-sm border border-stroke bg-green-600 p-1.5 shadow-sm border-green-400 dark:bg-boxdark lg:hidden"
          >
