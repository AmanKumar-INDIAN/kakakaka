...
import SidebarLinkGroup from "./Sidebargroups";
...
//   return <aside
//   ref={sidebar}
//   className={` absolute left-0 top-0 z-999 flex h-screen w-72.5 flex-col overflow-y-hidden
//    bg-black duration-300 ease-linear dark:bg-black  lg:static lg:translate-x-0 
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (  <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-green-900 duration-300 ease-linear  lg:static lg:translate-x-0 ${
        sidebarOpen ? 'translate-x-0' : '-translate-x-full'
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
