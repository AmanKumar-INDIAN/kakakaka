...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (  <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-50 flex h-screen w-72.5 flex-col overflow-y-hidden  bg-gradient-to-bl from-black to-green-900 duration-300 ease-linear  lg:static lg:translate-x-0 ${
...
<div className=" flex justify-center items-end relative top-10  my-10 ">

  <button className=" border border-green-600 p-2 mt-96 text-md rounded-lg w-full mx-4 ">Logout</button>
</div>
