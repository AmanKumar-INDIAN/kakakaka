...
import backimage from "/pback.jpg"
...
function Profile() {
 ...
 <DefaultLayout >
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-green-600 shadow-default lg:w-3/4  lg:mx-auto">
        <div className="relative z-2 h-35 ">
          <img
            src={backimage}
            alt="profile cover"
            className="h-[400px] w-full rounded-tl-sm rounded-tr-sm object-cover object-center"
          />

        </div>
        <div className="px-4  text-center ">
          <div className="relative -top-28 z-30 mx-auto  h-30  max-w-30 rounded-full bg-green-700/40 p-1 backdrop-blur h-44 w-44">
            <div className="relative  drop-shadow-2">
              <h1 className=' w-full h-[150px] rounded-full justify-center flex items-center text-4xl font-extrabold'>{"KA"}</h1>
          ...
          <div className=" relative bottom-20">
            ...
            <p className="font-medium">Profite partner</p>
            <div className="mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-3 rounded-md border border-green-500 py-2.5 shadow-1 bg-green-950">
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                <span className="font-semibold text-black dark:text-white">
                  59k
                </span>
                <span className="text-sm">Total Earn</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                <span className="font-semibold text-white">
                  129K
                </span>
                <span className="text-sm">Tottal deposit</span>
              </div>
            ...
            <div className="mx-auto max-w-180 my-4">
              <h4 className="font-semibold  my-4 text-xl underline text-black">
                About Me
              </h4>
     ...
     <div className="flex w-[70%] items-center justify-around gap-10 mt-4 ">
                <Link
                  to="#"
                  className="hover:text-green-900 text-black"
               ...
               width="30"
                ...
                <Link
                  to="#" 
                  className="hover:text-green-800 text-black"
                  aria-label="social-icon"
                >
                  <svg
                    className="fill-current"
