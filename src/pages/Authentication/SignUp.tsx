        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              {/* <span className="mb-1.5 block font-medium">Join</span> */}
              <h2 className="mb-9 my-5 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
             Join <span className='text-green-600'>Nvidia</span> 
              </h2>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link to="/auth/singin" className="text-primary">
